...
import "./App.css"
// function Recipe({ recipe: { name, cuisine, photo, ingredients, preparation }, onRemoveRecipe }) {

function Recipe({ recipe, index, deleteRecipe, editRecipe }) {
  ...
  return  editMode ? (
    ...
    <tr>
      ...
      <td>{(<img alt={recipe.photo} src={recipe.photo}  className="img_fit"></img>)}</td> 
...
//     <td>{name}</td>
//     <td>{cuisine}</td>
//     <td><img  src={photo} alt="" className="img_fit"></img></td>
//     <td className="content_td"><p>{ingredients}</p></td>
//     <td className="content_td"><p>{preparation}</p></td>
//     <td>
//       <button name="delete" onClick={onRemoveRecipe}>
//         Delete
//       </button>
//     </td>
//   </tr>
